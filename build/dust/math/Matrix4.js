module("/build/dust/math/Matrix4.js", function() {
    ...
    Matrix4.prototype = {
         ...
         * @param  {dust.math.Vector3} eye
         * @param  {dust.math.Vector3} center
         * @param  {dust.math.Vector3} up
         * @return {dust.math.Matrix4}
         */
         ...
         * @param  {dust.math.Matrix3} a
         * @return {dust.math.Matrix3}
         */
         ...
         * @param {dust.math.Vector3} [scale]
         * @param {dust.math.Quaternion} rotation
         * @param {dust.math.Vector} position
    ...
    if (Object.defineProperty) {
         ...
         * @name z
         * @type {dust.math.Vector3}
         * @memberOf dust.math.Matrix4
         * @instance
         */
